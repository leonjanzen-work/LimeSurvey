    ...
    <div class="container-fluid">
        <?php
            $this->widget('yiistrap.widgets.TbGridView', array(
                ...
                'template'        => "{items}\n<div id='userListPager'><div class=\"col-4\" id=\"massive-action-container\">$massiveAction</div><div class=\"col-4 pager-container ls-ba \">{pager}</div><div class=\"col-4 summary-container\">{summary}</div></div>",
